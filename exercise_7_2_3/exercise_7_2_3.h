#ifndef EXERCISE_7_2_3_H
#define EXERCISE_7_2_3_H
...
{
public:
    // contstructor to initialise base class (Article)
    Game(const std::string& name, int price);
    // default constructor
    Game();
    // converting constructor
    Game(const std::string& type, int esrb);
    // destructor
    ~Game();
...
public:
    ...
    Book(const std::string& name, int price);
    // default constructor
    Book();
    // converting constructor
    Book(const std::string& author, const std::string& isbn);
    // destructor
    ~Book();
...
public:
    // constructor to initialise base class (Article)
    Comic(const std::string& name, int price);
    // default constructor
    Comic();
    // converting constructor
    Comic(const std::string& serial_name, int serial_number);
    // destructor
    ~Comic();
